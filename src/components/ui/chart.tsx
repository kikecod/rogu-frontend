...
// Variables CSS en función del tema
...
// ========================
// Tooltip (wrapper nativo)
// ========================
const ChartTooltip = RechartsPrimitive.Tooltip;

// ------------------------
// Tipos planos del Tooltip
// ------------------------
type TooltipItem = {
  value?: number | string;
  name?: string;
  dataKey?: string;
  color?: string;
  payload: any; // estructura interna de Recharts por serie
};
...
type CustomLegendProps = React.HTMLAttributes<HTMLDivElement> & {
...
// =====================================
// Helper para obtener config desde payload
// =====================================
